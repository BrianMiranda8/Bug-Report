...
<body>
    ...
    <div class="main">
        ...
        <div class="header">
            <button data-new-bug class="button-1 small" placeholder="Add New Bug">New</button>

            <button id="new-bug-button" data-new-bug class="button-1" placeholder="Add New Bug">Add New Bug</button>
            <h1>Bug Report</h1>
        </div>
