...
class BugView
{
    ...
    {
        echo <<<'EOL'
                        <svg class="main-flower" xmlns="http://www.w3.org/2000/svg" width="250" height="353.976" viewBox="0 0 385.19 252.649" fill="#080808" xmlns:v="https://vecta.io/nano">

                    <path d="M191.321 31.593c-25.276 37.157-57.954 58.533-48.72 108.097-41.966 3.665-50.158 43.473-60.046 76.125-2.564 8.465-7.542 15.869-9.989 24.36 34.635 0 97.143 23.168 117.232-19.792h3.045c22.702 43.756 81.653 21.315 118.754 21.315-15.12-36.365-19.115-100.015-71.557-100.484 4.19-21.603 3.634-45.305-10.068-63.945-6.189-8.419-13.792-16.413-20.465-24.425-6.168-7.403-10.717-15.061-18.187-21.25" clip-path="url(#clipPath323-7)" image-rendering="pixelated" id="trillium-center"/>
